...
; ****************************************
	BL PortJ_Input
TestaBota
	CMP R0, #2_00000001 ;TESTA SE O BOTÃO ESTÁ PRECIONADO
	BNE Pisca_LED ;SE ESTIVER, VAI PRA SUBROTINA DO Pisca_LED
	MOV R0, #2_00 ;APAGA O LED
	BL PortN_Output ;FUNÇÃO PARA NÃO ACENDER NENHUM LED
	B MainLoop ;LOOPA
...
Pisca_LED
	...
	BL PortN_Output ;FUNÇÃO PARA ACENDER O LED
	MOV R0, #1000 ;DEFINE O TEMPO DE ESPERA COMO 1 SEGUNDO
	BL SysTick_Wait1ms ;AGUARDA UM SEGUNDO
	B MainLoop ;RETORNA PARA O LOOP
